...
public class ConsultaService {
    ...
    public List<Consulta> listar() { return consultaRepository.findAll(); }
    ...
    public Consulta atualizar(Long id, Consulta consultaAtualizada) {
        ...
        if (consultaAtualizada.getDataHora() != null) consultaExistente.setDataHora(consultaAtualizada.getDataHora());
        if (consultaAtualizada.getStatus() != null) consultaExistente.setStatus(consultaAtualizada.getStatus());
        if (consultaAtualizada.getValor() != null) consultaExistente.setValor(consultaAtualizada.getValor());
    ...
    public List<Consulta> listarPorMedico(Long medicoId) { return consultaRepository.findByMedicoId(medicoId); }
    public List<Consulta> listarPorPaciente(Long pacienteId) { return consultaRepository.findByPacienteId(pacienteId); }
}
