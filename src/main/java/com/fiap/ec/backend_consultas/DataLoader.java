...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        consultaRepository.saveAll(List.of(
                new Consulta(medico1, paciente1, LocalDateTime.of(2026, 5, 20, 9, 0), "agendada", 250.00, "Consulta de rotina"),
                new Consulta(medico2, paciente2, LocalDateTime.of(2026, 5, 21, 14, 30), "confirmada", 350.00, "Retorno pós-exame"),
                new Consulta(medico1, paciente2, LocalDateTime.of(2026, 5, 15, 10, 0), "realizada", 200.00, null),
                new Consulta(medico2, paciente1, LocalDateTime.of(2026, 5, 18, 11, 0), "cancelada", 300.00, "Paciente desmarcou")
        ));
